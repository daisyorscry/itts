...
import { useRejectRegistration } from '@feature/registration/hooks';
import {
  rejectRegistrationSchema,
  type Registration,
  type RejectRegistrationFormData,
} from '@feature/registration/types';
...
export function RejectRegistrationModal({
  ...
  const form = useForm<RejectRegistrationFormData>({
